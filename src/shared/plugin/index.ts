  ...
  _loadParametersFromObject: function (e) {
    ...
    for (n in e)
      if (e.hasOwnProperty(n)) {
        const r = this._getStringFromParameter(e[n]);
  ...
  _loadParameterValue: function (e, n) {
    ...
    if (n instanceof Array) {
      for (r = 0; r < n.length; r++) {
        const i = this._getStringFromParameter(n[r]);
...
export default {
  ...
  supportedSearchType: ["music", "album", "playlist", "artist"],
